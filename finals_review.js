...
function updateMember(id) {
    fetch(`https://reviewer-finals-deployment.onrender.com/api/members/${id}`)  // Corrected URL
...
// Update button listener for submitting the updated data
updateBTN.addEventListener('click', () => {
    ...
    fetch('https://reviewer-finals-deployment.onrender.com/api/members', {  // Corrected URL
        method: 'PUT',
